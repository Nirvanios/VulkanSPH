...
void Buffer::copyBuffer(const vk::DeviceSize &copySize, const vk::UniqueBuffer &srcBuffer, const vk::UniqueBuffer &dstBuffer, const std::vector<vk::Semaphore> &semaphores) {
...
void Buffer::copy(const vk::DeviceSize &copySize, const Buffer &srcBuffer, const std::vector<vk::Semaphore> &semaphores) {
    copyBuffer(copySize, srcBuffer.getBuffer(), buffer, semaphores);
}
void Buffer::copy(const vk::DeviceSize &copySize, const Buffer &srcBuffer, const Buffer &dstBuffer, const std::vector<vk::Semaphore> &semaphores) {
