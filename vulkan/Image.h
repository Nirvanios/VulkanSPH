...
public:
    Image(vk::UniqueImage image, vk::UniqueDeviceMemory imageMemory, vk::Format format, int width, int height, const vk::ImageAspectFlags& aspect);
    Image(vk::UniqueImage image, vk::Format imageFormat, int width, int height, const vk::ImageAspectFlags& aspect);
    void createImageView(const std::shared_ptr<Device> &device, const vk::ImageAspectFlags &aspectFlags);
    void transitionImageLayoutNow(const std::shared_ptr<Device> &device, const vk::UniqueCommandPool &commandPool, const vk::Queue &queue,
                               vk::ImageLayout oldLayout, vk::ImageLayout newLayout);
    void transitionImageLayout(const vk::UniqueCommandBuffer &commandBuffer, vk::ImageLayout oldLayout, vk::ImageLayout newLayout,
